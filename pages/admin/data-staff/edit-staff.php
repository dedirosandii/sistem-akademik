		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item"><a href="?page=data-staff">Data Staff</a></li>
...
<div class="content">
	<div class="row">
		<div class="col-12">
			<div class="card card-edit-staff">
				...
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
							<div class="table-responsive table-detail-staff">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-sm">
									...
									<tr>
										<td><b>Jabatan</b></td>
										<td>
											<input type="text" class="form-control" value="IT Staff" required>
										</td>
									</tr>
									<tr>
